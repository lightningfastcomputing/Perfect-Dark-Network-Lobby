...
![Perfect Dark native network lobby with two connected players](screenshots/in-game-network-lobby.png)
...
The launcher provides player presence and chat before either side starts the game.

![Perfect Dark pre-lobby chat with host and client connected](screenshots/pre-lobby-chat.png)

### Native in-game lobby

After launch, both players are sent directly into the game's real network lobby.

![Perfect Dark in-game network lobby](screenshots/in-game-network-lobby.png)
